...
Route::group(['middleware' => 'auth'], function () {
    ...
    //   Route::post('/pelanggan/import', [PelangganController::class, 'importExcel'])->name('pelanggan.import');
     ...
     Route::get('/penempatan/pdf/{awal}/{akhir}/{id}', [PenempatanController::class, 'exportDaily'])->name('penempatan.export');
          ...
          Route::post('/omset/updated/{id}', [CodController::class, 'updated'])->name('omset.updated');
   ...
   // Rute untuk update (metode PUT atau PATCH)
   Route::post('/absen/updated/{id}', [AbsensiController::class, 'updated'])->name('absen.updated');
   Route::delete('/absen/destroy/{id}', [AbsensiController::class, 'destroy'])->name('absen.destroy');
 ...
 // Absen Filter 
Route::get('/absen-topcellular', [AbsensiController::class, 'topcellular'])->name('absen.topcellular');
Route::get('/data-topcellular', [AbsensiController::class, 'dataTopCellular'])->name('dataTopCellular');
Route::get('/absen-topbeauty', [AbsensiController::class, 'topbeauty'])->name('absen.topbeauty');
Route::get('/data-topbeauty', [AbsensiController::class, 'dataTopBeauty'])->name('dataTopBeauty');
Route::get('/absen-topgym', [AbsensiController::class, 'topgym'])->name('absen.topgym');
Route::get('/data-topgym', [AbsensiController::class, 'dataTopGym'])->name('dataTopGym');
Route::get('/absen-topfood', [AbsensiController::class, 'topfood'])->name('absen.topfood');
Route::get('/data-topfood', [AbsensiController::class, 'dataTopFood'])->name('dataTopFood');
...
Route::post('/absen-dec-selected', [AbsensiController::class, 'declineSelected'])->name('absen.decselected');
            ...
            Route::delete('/cleaning/{id}', [CleaningController::class, 'destroy'])->name('cleaning.destroy');
